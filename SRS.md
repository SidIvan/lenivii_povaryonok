...
### Системная функция — `PhotoParser.parseBar`, распознание штрих-кода продукта
...
### Системная функция — `Interface.gen_recipes`, создание списка рецептов по спику продуктов
